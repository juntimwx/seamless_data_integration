...
data = pd.read_excel(r'D:\Seamless data integration\analysis_resources\muic_student_disciplinary\datasets\Template_StudentDisciplinary_v.2024.05.20_SA.xlsx')
...
df.to_sql("sa_student_disciplinary", engine, index=False, chunksize=500, if_exists='append')