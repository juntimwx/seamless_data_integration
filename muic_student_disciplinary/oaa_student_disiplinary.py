...
data = pd.read_excel(r'../data/muic_student_disciplinary/Template_StudentDisciplinary_v.2024.05.20_OAA.xlsx')
...
try:
    ...
    result = df.to_sql(os.getenv('OAA_DISCIPLINARY_TABLE'), engine, schema=os.getenv('SCHEMA_DEFAULT'), index=False,
