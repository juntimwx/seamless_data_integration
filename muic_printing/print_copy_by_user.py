...
file_name = 'print_copy_summary_by_user_Nov_2024'
data = pd.read_csv(fr'D:\Seamless data integration\analysis_resources\muic_printing\datasets\{file_name}.csv',
...
print(df)
df.to_sql('print_copy_summary_by_user_Nov_2024', engine, index=False, chunksize=500, if_exists='append')  #replace