...
data = pd.read_excel('../../data/muic_finance/master/Master_IO_Goods_2023.05.31.xlsx')
...
df = df.rename(columns={
    'IO_Goods_Id' : 'id',
    'IO_Goods_Description' : 'description'
})
...
try:
    ...
    result = df.to_sql(os.getenv('IO_GOODS_TABLE'), engine, schema=os.getenv('SCHEMA_MASTER'), index=False, chunksize=500, if_exists='append')
