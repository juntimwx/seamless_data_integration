...
data = pd.read_excel('../../data/muic_finance/master/Master_IC_Strategy_2023.05.31.xlsx')
...
try:
    ...
    result = df.to_sql(os.getenv('IC_STRATEGY_TABLE'), engine, schema=os.getenv('SCHEMA_MASTER'), index=False, chunksize=500, if_exists='append')
