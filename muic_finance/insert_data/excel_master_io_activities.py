...
data = pd.read_excel('../../data/muic_finance/master/Master_IO_Activity_2023.05.31.xlsx')
...
df = df.rename(columns={
    'IO_Activity_Id' : 'id',
    'IO_Activity_Description' : 'description'
})
...
try:
    ...
    result = df.to_sql(os.getenv('IO_ACTIVITIES_TABLE'), engine, schema=os.getenv('SCHEMA_MASTER'), index=False, chunksize=500, if_exists='append')
