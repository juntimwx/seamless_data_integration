...
data = pd.read_excel('../../data/muic_asset_inventory/Item-2025-01-16.xlsx')
...
try:
    ...
    result = df.to_sql(os.getenv('ITEM_TABLE'), engine, schema=os.getenv('SCHEMA_DEFAULT'), index=False, chunksize=500, if_exists='append')
