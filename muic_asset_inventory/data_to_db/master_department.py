...
data = pd.read_excel('../../data/muic_asset_inventory/Departments-2025-01-16.xlsx')
...
try:
    ...
    result = df.to_sql(os.getenv('DEPARTMENT_TABLE'), engine, schema=os.getenv('SCHEMA_MASTER'), index=False, chunksize=500, if_exists='append')
