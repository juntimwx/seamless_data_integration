...
df['QN_WORK_ADD'] = helpers_v3.get_work_address_name_text(df_data)
df['QN_WORK_MOO'] = helpers_v3.get_work_address_moo_text(df_data)
df['QN_WORK_BUILDING'] = helpers_v3.get_work_address_building_text(df_data)
df['QN_WORK_SOI'] = helpers_v3.get_work_address_soi_text(df_data)
df['QN_WORK_STREET'] = helpers_v3.get_work_address_street_text(df_data)
df['QN_WORK_TAMBON'] = helpers_v3.get_work_address_tambon_text(df_data)
...
df['QN_WORKNEED_ID'] = helpers_v3.get_workneed_series(df_data)
