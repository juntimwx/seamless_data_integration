...
import os
from helpers.ds1004_student_job_v2 import (get_citizen_id_series,get_work_status_series,get_military_status_series,get_ordinate_status_series,get_occupation_type_series,get_occupation_text,get_talent_id_series,
...
data = pd.read_excel(fr'D:\Seamless data integration\analysis_resources\op_db\datasets\ds1004_student_job\[MUIC IT] Final ภาวะมีงานทำปี 2565.xlsx')
