...
df['QN_PROGRAM_EDU_ID'] = helpers_2566_v1.get_program_education_id_series(df_data)
...
df['QN_PROB_EDU'] = helpers_2566_v1.get_problem_education_series(df_data)
df['QN_PROB_EDU_TXT'] = helpers_2566_v1.get_problem_education_text(df_data)
