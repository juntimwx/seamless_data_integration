...
print(df)
df.to_sql('finance_invoice_20250314', engine, index=False, chunksize=500, if_exists='append')
# df.to_sql('finance_invoice_20250307', engine, index=False, chunksize=500, if_exists='append')
# df.to_sql('finance_invoice_20250228', engine, index=False, chunksize=500, if_exists='append')
